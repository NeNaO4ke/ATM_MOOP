...
public enum TransactionalAccountPlan {
    ...
    PLAIN("Plain",false, BigDecimal.ZERO, BigDecimal.ZERO),
    LIGHT("Light",true, BigDecimal.valueOf(1000), BigDecimal.valueOf(5)),
    MEDIUM("Medium",true, BigDecimal.valueOf(5000), BigDecimal.valueOf(4));
